...
import { CalendarPlus, Users, Search, FileText, ArrowRight, CheckCircle } from 'lucide-react'
...
const QuickActionsPanel = () => {
  const actions = [
    ...
    {
      title: 'ACB Confirmation',
      description: 'Confirm advance call booking appointments',
