...
const NotificationsPanel = () => {
  ...
  const notifications = [{
    ...
    description: '14 appointments require confirmation for ABC Corporation',
    time: '10 minutes ago',
    priority: 'high'
  }, {
    id: 2,
    ...
    description: 'Dr. Michael Chen has rescheduled 3 appointments',
    time: '3 hours ago',
    priority: 'medium'
  }];
  ...
  return <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        {notifications.map(notification => <div key={notification.id} className="p-4 hover:bg-gray-50 cursor-pointer">
            <div className="flex">
              <div className={`p-2 rounded-full mr-3 ${notification.priority === 'high' ? 'bg-red-50' : 'bg-amber-50'}`}>
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex justify-between items-center">
                  <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${notification.priority === 'high' ? 'bg-red-100 text-red-800' : 'bg-amber-100 text-amber-800'}`}>
